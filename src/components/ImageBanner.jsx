...
const ImageBanner = () => {
  return (
    <>
        ...
        initial='hidden' 
        whileInView={'show'} 
        className=' flex content-center p-12 lg:flex-1 lg:mx-0 items-center max-w-[320px] lg:max-w-[482px] '
        >

            <h1 className='absolute lg:hidden opacity-10 translate-x-[-33px] text-[185px] font-bold leading-[0.8] sm:mt-10 md:text-[250px] text-white'>FITNESS</h1>
            
            <h2 className='absolute  translate-y-[-70px] md:translate-y-[-140px]  translate-x-[-40px] md:translate-x-[-80px] opacity-70 z-10 m-0 lg:hidden text-[40px] md:text-[80px] font-bold leading-[0.8] text-white'>You Can</h2>
